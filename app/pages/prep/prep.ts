...
operators: string;
  ...
  openDocs() {
    let dua = {
      name: 'Маленькая сумка для хаджа',
      image: '',
      text: '1. Билет на самолет<br>2. Копию паспорта и визы (также сфотографируйте их на телефон)<br>3. Сертификат шахады (если вы обращенный в ислам в немусульманской стране)<br>4. Адрес отеля (на английском и арабском)<br>5. Наличные деньги (ориентируйтесь на 500$ на человека)<br>6. Лекарства<br>7. Очки, контактные линзы'
    };
  ...
  openAdd() {
    let dua = {
      name: 'Дополнительно',
      image: '',
      text: ' Зонтик от солнца <br> Руководство хаджа, маленькую копию Корана, книги с дуа (можно использовать приложения для телефона)<br> Фонарик (есть во многих телефонах)<br> Немного порошка для стирки<br> Молитвенный коврик<br> Иголка, нитки, булавка<br> Кружка, ложка, вилка, нож, тарелка, кипятильник <br> Телефон, зарядник (удлинитель, переходник с 3-х фазной розетки)<br> Ручные весы<br> Телефон, ноутбук<br> Беруши (для удобства сна в Мине)'
    };
    this.nav.push(SlidePage, dua);
  }
